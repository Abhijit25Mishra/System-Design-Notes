...
This generates a set of source files that provide rich, lanuage-specific APIs for the message defined in .proto file. The generated code typically includes:
